...
**Introduction project to setup rails back-end with react/redux front-end. This setup is for the front-end only.
** Link for back-end API
** https://github.com/Yosefgeda/rails-react-backend/pull/1
...
- Generates random greetings fetching from rails app backend database.
...
To clone: git clone git@github.com:yosefgeda/rails-react-frontend.git
to change to directory: cd rails-react-frontend
...
Inside the hello-rails-react directory run "npm install" to install all the dependencys.
Run "npm start" then every thing shoud work as intended.
This server should be run on 'localhost 3001'
...
Feel free to check the [issue page](https://github.com/yosefgeda/rails-react-frontend/issues)
